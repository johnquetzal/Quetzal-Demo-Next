                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                        <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                            <h1 className="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl md:text-6xl">
                                {t(
                                    "Internationalize <dynamic1>In minutes</dynamic1>",
                                    {
                    ...
                    <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                        ...
                        <div className="mt-10 lg:mt-0">
                            ...
                            <div className="mt-5">
                                ...
                                <p className="mt-2 text-base text-gray-500">
                                    {t(
                                        "New translations will be found and translated whenever you run a build, or run `npx quetzal-process-translations`. We recommend using our VSCode extension for the best experience."
                                    )}
                                </p>
                            </div>
                        </div>
